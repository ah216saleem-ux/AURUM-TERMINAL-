...
export const INITIAL_MARKETS: MarketItem[] = [
  {
    ...
    exchange: 'COMEX / LBMA',
    decimals: 2,
    sparkline: [2628.1, 2631.4, 2629.8, 2635.2, 2638.9, 2636.5, 2641.0, 2639.4, 2644.2]
  },
  {
    id: 'xag-usd',
    symbol: 'XAG/USD',
    ...
    exchange: 'COMEX',
    decimals: 2,
    sparkline: [30.75, 30.90, 31.10, 31.05, 31.22, 31.18, 31.35, 31.30, 31.45]
  },
  {
    id: 'nasdaq-100',
    symbol: 'NASDAQ 100',
    ...
    exchange: 'NASDAQ / CME',
    decimals: 2,
    sparkline: [19710, 19685, 19740, 19790, 19760, 19810, 19830, 19800, 19846.5]
  },
  {
    id: 'sp-500',
    symbol: 'S&P 500',
    ...
    exchange: 'S&P / CME',
    decimals: 2,
    sparkline: [5668, 5674, 5670, 5682, 5679, 5685, 5680, 5684, 5688.3]
  },
  {
    id: 'crude-oil',
    ...
    exchange: 'NYMEX',
    decimals: 2,
    sparkline: [72.3, 72.1, 71.8, 71.5, 71.6, 71.2, 70.9, 71.0, 70.85]
  },
  {
    id: 'eur-usd',
    symbol: 'EUR/USD',
    ...
    decimals: 4,
    sparkline: [1.0812, 1.0818, 1.0825, 1.0834, 1.0828, 1.0842, 1.0839, 1.0848]
  },
  {
    id: 'gbp-usd',
    symbol: 'GBP/USD',
    ...
    exchange: 'INTERBANK FX',
    decimals: 4,
    sparkline: [1.3070, 1.3085, 1.3092, 1.3105, 1.3098, 1.3118, 1.3110, 1.3125]
  },
  {
    id: 'usd-jpy',
    symbol: 'USD/JPY',
    ...
    exchange: 'INTERBANK FX',
    decimals: 2,
    sparkline: [155.30, 155.15, 154.95, 155.05, 154.80, 154.65, 154.70, 154.55]
  },
  {
    id: 'aud-usd',
    symbol: 'AUD/USD',
    ...
    exchange: 'INTERBANK FX',
    decimals: 4,
    sparkline: [0.6695, 0.6702, 0.6710, 0.6708, 0.6718, 0.6715, 0.6724]
  },
  {
    id: 'usd-cad',
    symbol: 'USD/CAD',
    ...
    exchange: 'INTERBANK FX',
    decimals: 4,
    sparkline: [1.3615, 1.3605, 1.3592, 1.3600, 1.3588, 1.3582, 1.3578]
  },
  {
    id: 'btc-usd',
    symbol: 'BTC/USD',
    ...
    decimals: 2,
    sparkline: [62200, 62450, 62800, 63100, 62900, 63400, 63650, 63840]
  }
];
