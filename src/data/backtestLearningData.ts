...
export const ASSET_BACKTEST_DATA: AssetBacktestSummary[] = [
  ...
  },
  {
    ...
    winRate: 82.94,
    profitFactor: 2.76,
    bestTimeframe: '15M & 1H Intraday',
    totalRMultiple: '+810.5R',
    maxDrawdown: '-3.5%',
    testedPeriod: '2024 - 2026 Historical Dataset',
    equityCurvePoints: [100, 107, 114, 120, 118, 130, 142, 155, 168, 174, 188, 202, 218]
  },
  {
    assetId: 'gbp-usd',
    symbol: 'GBP/USD',
    ...
    winRate: 82.17,
    profitFactor: 2.65,
    bestTimeframe: '15M & 1H London Breakout',
    totalRMultiple: '+742.0R',
    maxDrawdown: '-3.9%',
    testedPeriod: '2024 - 2026 Historical Dataset',
    equityCurvePoints: [100, 106, 112, 119, 115, 128, 137, 149, 160, 168, 180, 194, 208]
  },
  {
    assetId: 'usd-jpy',
    symbol: 'USD/JPY',
    ...
    winRate: 81.16,
    profitFactor: 2.58,
    bestTimeframe: '30M & 4H Tokyo Sweep',
    totalRMultiple: '+698.4R',
    maxDrawdown: '-4.1%',
    testedPeriod: '2024 - 2026 Historical Dataset',
    equityCurvePoints: [100, 104, 110, 117, 113, 124, 135, 146, 158, 164, 178, 190, 202]
  },
  {
    assetId: 'aud-usd',
    symbol: 'AUD/USD',
    ...
    winRate: 80.00,
    profitFactor: 2.42,
    bestTimeframe: '1H & 4H Swing',
    totalRMultiple: '+540.2R',
    maxDrawdown: '-4.3%',
    testedPeriod: '2024 - 2026 Historical Dataset',
    equityCurvePoints: [100, 105, 110, 115, 112, 122, 130, 138, 148, 154, 165, 174, 185]
  },
  {
    assetId: 'usd-cad',
    symbol: 'USD/CAD',
    ...
    winRate: 79.37,
    profitFactor: 2.38,
    bestTimeframe: '1H & 1D Structure',
    totalRMultiple: '+498.0R',
    maxDrawdown: '-3.8%',
    testedPeriod: '2024 - 2026 Historical Dataset',
    equityCurvePoints: [100, 103, 108, 114, 111, 120, 128, 136, 144, 150, 160, 168, 178]
  },
  {
    assetId: 'btc-usd',
    symbol: 'BTC/USD',
    ...
    winRate: 82.07,
    profitFactor: 2.92,
    bestTimeframe: '15M & 4H Volatility Breakout',
    totalRMultiple: '+1120.5R',
    maxDrawdown: '-5.8%',
    testedPeriod: '2024 - 2026 Historical Dataset',
    equityCurvePoints: [100, 110, 122, 116, 132, 148, 162, 178, 195, 188, 210, 232, 255]
  }
];
