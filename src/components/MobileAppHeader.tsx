  ...
  return (
    <div className="relative w-full overflow-hidden rounded-3xl bg-gradient-to-b from-[#10131e] via-[#0b0d14] to-[#07080c] border border-amber-500/25 p-5 shadow-xl">
      ...
      <div className="relative mt-2 h-28 sm:h-32 w-full flex items-center justify-center">
        ...
        <div className="pointer-events-none absolute bottom-1 flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-black/60 backdrop-blur-md border border-zinc-800 text-[10px] font-mono-num text-zinc-400">
          <Radio className="w-2.5 h-2.5 text-amber-400" />
          <span>Institutional SMC Algorithms Active</span>
        </div>
      </div>
    </div>
  );
